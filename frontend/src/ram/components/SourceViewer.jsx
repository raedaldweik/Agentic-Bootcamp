      ...
      <div className="glass-card w-full max-w-[640px] max-h-[80vh] flex flex-col animate-slide-up"
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b border-[rgba(43,83,120,0.10)]">
          <div className="flex items-center gap-2 min-w-0">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--sas)" strokeWidth="2" className="shrink-0">
              <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>
            </svg>
            <span className="text-sm font-bold truncate" style={{ color: 'var(--text)' }}>{title}</span>
            {meta.page != null && (
              <span className="text-[10px] px-1.5 py-0.5 rounded shrink-0"
                style={{ background: 'rgba(43,83,120,0.08)', color: 'var(--sas)' }}>p. {meta.page}</span>
            )}
          </div>
