...
const markdownComponents = {
  ...
  th: ({node, ...props}) => <th className="px-2 py-1.5 text-start font-semibold" style={{ border: '1px solid rgba(7,102,209,0.15)', color: 'var(--sas)' }} {...props} />,
  ...
  code: ({node, className, children, ...props}) => {
    ...
    return block
      ...
      : <code className="px-1 py-0.5 rounded text-[12px]" style={{ background: 'rgba(7,102,209,0.08)', color: 'var(--sas)' }} {...props}>{children}</code>;
  },
        ...
        <div className="flex flex-wrap gap-2">
          {data.context.map((doc, i) => (
            <button key={i} onClick={() => onOpenSource?.(doc)}
              ...
              style={{ color: 'var(--sas-lo)', background: 'rgba(7,102,209,0.06)', border: '1px solid rgba(7,102,209,0.18)' }}>
