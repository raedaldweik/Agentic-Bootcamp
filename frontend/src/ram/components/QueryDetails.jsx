  ...
  return (
    <div className="rounded-xl overflow-hidden" style={{ border: '1px solid rgba(7,102,209,0.14)' }}>
      <button onClick={() => setOpen(!open)}
        className="w-full flex items-center gap-2 px-4 py-2.5 text-start transition-all hover:bg-[rgba(7,102,209,0.04)]"
        ...
        {count != null && (
          <span className="text-[10px] px-1.5 py-0.5 rounded-full font-bold"
            style={{ background: 'rgba(7,102,209,0.10)', color: 'var(--sas)' }}>{count}</span>
        )}
      </button>
...
const Pill = ({ children }) => (
  <span className="text-[10px] px-2 py-0.5 rounded-full font-semibold"
    style={{ background: 'rgba(7,102,209,0.08)', color: 'var(--sas-lo)', border: '1px solid rgba(7,102,209,0.15)' }}>
    {children}
  </span>
);
              ...
              <div key={c.id || i} className="rounded-lg px-3 py-2.5 space-y-2" style={{ border: '1px solid rgba(7,102,209,0.10)' }}>
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0"
                    style={{ background: 'rgba(7,102,209,0.12)', color: 'var(--sas)' }}>{i + 1}</span>
