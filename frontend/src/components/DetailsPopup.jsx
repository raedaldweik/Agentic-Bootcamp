  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-6" onClick={onClose}
      ...
      <div className="glass-card w-full max-w-[760px] max-h-[85vh] flex flex-col animate-slide-up"
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b border-[rgba(0,122,115,0.10)]">
          ...
          <button onClick={onClose} className="p-1.5 rounded-lg hover:bg-[rgba(0,122,115,0.08)]" style={{ color: 'var(--text-dim)' }}>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-3">
          <div className="rounded-xl px-4 py-3" style={{ background: 'rgba(0,122,115,0.05)', border: '1px solid rgba(0,122,115,0.14)' }}>
          ...
          <div>
            ...
            <div className="space-y-2">
              {(data.trace || []).map((t, i) => (
                <div key={i} className="rounded-lg px-3 py-2.5" style={{ border: '1px solid rgba(0,122,115,0.10)' }}>
                  <div className="flex items-center gap-2 flex-wrap mb-1">
                    <span className="w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0"
                      style={{ background: 'rgba(0,122,115,0.12)', color: 'var(--brand)' }}>{i + 1}</span>
