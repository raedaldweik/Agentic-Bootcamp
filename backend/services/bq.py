    ...
    with _lock:
        ...
        try:
            ...
            try:
                ...
                ds.description = "Basira synthetic Qatar HIE, 8 relational tables, 36 months, zero PHI"
...
def provision_in_background():
    ...
    threading.Thread(target=work, name="basira-bq-provision", daemon=True).start()
...
def query(sql: str, max_rows: int = 200) -> dict:
    ...
    cfg = bigquery.QueryJobConfig(
        ...
        use_query_cache=True, labels={"app": "basira", "caller": "cohort_agent"})
    t0 = time.time()
    try:
