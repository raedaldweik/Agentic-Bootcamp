"""
Basira, grounded retrieval over the national clinical guideline corpus.
...
"NHA CG01 Type2 Diabetes Management, p. 7" and the UI can open the source passage.
Under SAS RAM: a document collection with the same search contract.
"""
...
logging.getLogger("pypdf").setLevel(logging.ERROR)   # cosmetic font warnings on guideline PDFs
