"""
Where Basira is running and which backends are live.
...
BQ_DATASET = os.getenv("BQ_DATASET", "basira_hie").strip()
...
REGION = os.getenv("BASIRA_REGION", "").strip() or ("me-central1" if COMPUTE == "cloud-run" else None)
SERVICE = os.getenv("K_SERVICE") or os.getenv("RAILWAY_SERVICE_NAME") or "basira"
